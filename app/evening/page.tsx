...
function EveningForm() {
  ...
  return (
    <main className="min-h-screen">
      <section className="bg-gradient-to-br from-stone-50 via-indigo-50/30 to-stone-100 px-6 pt-12 pb-10">
        <div className="max-w-2xl mx-auto">
          ...
          <h1 className="text-3xl font-bold text-stone-800 tracking-tight">Evening Check-in</h1>
          <p className="mt-2 text-stone-600">
            {isEditing
              ? `Editing ${formattedDate}`
              : alreadyLogged && !saved
              ? "You already logged this evening — update below if needed."
